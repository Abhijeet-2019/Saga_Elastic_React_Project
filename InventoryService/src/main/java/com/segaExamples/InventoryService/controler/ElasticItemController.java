...
public class ElasticItemController {
    ...
    public ResponseEntity<List<InventoryDetailsElastic>> initialLoadItems(
            @RequestParam(name = "fetchSize") int fetchSize,
    ...
    public ResponseEntity<List<InventoryDetailsElastic>> fetchedSelectedItems(@RequestParam(name = "nameSearch") String nameSearch,
        ...
        return ResponseEntity
                ...
                .body(fetchedItemSearched);
    }


    @PostMapping("/uploadBulkItems")
    public List<InventoryDetailsElastic> uploadBulkItemsInElastic
            (@RequestBody List<InventoryDetailsElastic> inventoryDetailsList) {
